class Card:
    ...
    """None - чтобы выровнять список по порядку. Так "2" = 2 по списку"""
...
class Game:
    ...
    def play_game(self):
        ...
        print("Поехали!")
        print("Нажмите X для выхода. Нажмите любую другую клавишу для начала игры.")
        while len(cards) >= 2:
            m = "\n"
            response = input(m)
            if response == 'X':
        ...
        print("Игра окончена. Победитель - {}!".format(win))
